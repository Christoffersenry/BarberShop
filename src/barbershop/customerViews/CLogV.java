 ...
 * @author rcvb8
 */
public class CLogV extends JFrame {
...
//        PREVIOUS BUTTON TO RETURN TO HOME SCREEN
        ...
        prevB.addActionListener(cLogCon);
        ...
        JLabel cLogin = new JLabel("Customer Login");
        Dimension dBanner = new Dimension(450, 50);
        cLogin.setPreferredSize(dBanner);
        cLogin.setHorizontalAlignment(JLabel.CENTER);
        centerPanel.add(cLogin);        
...
//         LOG IN BUTTON WITH ACTION LISTENER
        ...
        login.addActionListener(cLogCon);
...
//         ADDS LINK TO CUSTOMER REGISTRATION PAGE
        ...
        register.addMouseListener(cLogCon);
